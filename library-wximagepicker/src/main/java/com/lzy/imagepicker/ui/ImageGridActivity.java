...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageGridAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    private ImageButton mBtnOk;       //确定按钮
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnOk = (ImageButton) findViewById(R.id.tv_photo_picker_submit);
    ...
    protected void initTitleBar(){
        if("sto".equals(brandType)){
            ...
            top_bar.setBackgroundColor(ContextCompat.getColor(this, R.color.sto_text_color));
        }
    }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.tv_photo_picker_submit) {
            ...
            intent.putExtra(ImageBaseActivity.EXTRA_BRAND_TYPE,getIntent().getStringExtra(ImageBaseActivity.EXTRA_BRAND_TYPE));
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        if (imagePicker.getSelectImageCount() > 0) {
            tvDes.setText(getString(R.string.select_complete, imagePicker.getSelectImageCount()+"", imagePicker.getSelectLimit()+""));
