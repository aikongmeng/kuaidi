...
public class ImagePreviewActivity extends ImagePreviewBaseActivity implements ImagePicker.OnImageSelectedListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private ImageButton mBtnOk;                         //确认图片的选择
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnOk = (ImageButton) topBar.findViewById(R.id.tv_photo_picker_submit);
        mBtnOk.setVisibility(View.VISIBLE);
        mBtnOk.setOnClickListener(this);
        tvDes= (TextView) topBar.findViewById(R.id.tv_des);
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        if (imagePicker.getSelectImageCount() > 0) {
            ...
            tvDes.setText(getString(R.string.complete));
