...
public class SkuaidiRelativeLayout extends RelativeLayout {
	...
	public SkuaidiRelativeLayout(Context context) {
		super(context);
	}
	
	public SkuaidiRelativeLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
