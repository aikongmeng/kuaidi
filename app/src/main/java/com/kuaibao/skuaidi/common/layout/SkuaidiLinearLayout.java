...
@SuppressLint("NewApi")
public class SkuaidiLinearLayout extends LinearLayout {
	...
	public SkuaidiLinearLayout(Context context) {
		super(context);
	}
	public SkuaidiLinearLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public SkuaidiLinearLayout(Context context, AttributeSet attrs, int defStyle) {
