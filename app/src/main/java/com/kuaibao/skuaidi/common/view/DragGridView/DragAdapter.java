...
public class DragAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		item_text = (TextView) view.findViewById(R.id.tv_name);
		item_image = (ImageView) view.findViewById(R.id.iv_icon);
		String channel = getItem(position);
		item_text.setText(channel);
		item_image.setBackgroundResource(BusinessFragment.idNameMap.get(channel));
