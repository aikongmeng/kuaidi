...
import com.kuaibao.skuaidi.activity.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public static final int OPERATE_TYPE_TAKEPIC = 99;
	...
	public void handleMessage(Message message) {
		...
		case OPERATE_TYPE_TAKEPIC:
			isTake = (Boolean) message.obj;
			break;
