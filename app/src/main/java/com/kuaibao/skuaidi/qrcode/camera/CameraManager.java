...
package com.kuaibao.skuaidi.qrcode.camera;
...
public final class CameraManager {
	 ...
	 */
	public static void init(Context context,String type) {
	...
	/**
	 * 开启相机预览界面 Asks the camera hardware to begin drawing preview frames to the
	 * screen.
	 */
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			// }
			int height;
			 //Log.d("iii", "height:llllllllllllllllllll");
			//收款扫描框小些
			if("CollectionAddExpressNoActivity".equals(scanType)){
				 height = screenResolution.y / 5;
				 //Log.d("iii", "height:555555555555555555"+height);
			}else{
				 height = screenResolution.y / 4;
				 //Log.d("iii", "height:44444444444444444"+height);
			}
			...
			if("CollectionAddExpressNoActivity".equals(scanType)){
				framingRect = new Rect(leftOffset,Utility.dip2px(context, 44), leftOffset + width, Utility.dip2px(context, 44)+ height);
			}else{
				framingRect = new Rect(leftOffset, Utility.dip2px(context, 44)+topOffset / 8, leftOffset + width, Utility.dip2px(context, 44)+topOffset / 8 + height);
			}
