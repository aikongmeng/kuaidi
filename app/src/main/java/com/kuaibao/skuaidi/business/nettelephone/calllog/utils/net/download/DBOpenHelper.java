...
public class DBOpenHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS filedownlog (id integer primary key autoincrement," +
				" downpath varchar(100), threadid INTEGER, downlength INTEGER, totallength INTEGER)");
		db.execSQL("CREATE TABLE IF NOT EXISTS filehttplog (id integer primary key autoincrement," +
				" downpath varchar(100), totallength INTEGER)");
	}
