...
//                        textView.setBackgroundResource(R.drawable.actionsheet_bottom_selector);
            ...
            line.setBackgroundResource(R.color.gray_4);
            // 高度
            int lineHeight = (int) (scale + 0.5f);
            line.setLayoutParams(new LinearLayout.LayoutParams( LayoutParams.MATCH_PARENT, lineHeight));
    ...
    public enum SheetItemColor {
        Blue("#037BFF"), Red("#FD4A2E"),Black_333333("#333333"),Gray_666666("#666666");
