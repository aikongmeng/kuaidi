package com.kuaibao.skuaidi.popup.baselib;
...
public abstract class BasePopupWindow implements BasePopup {
    ...
    public EditText getInputView() { return null; }
    ...
    private void tryToShowPopup(int res, View v) throws Exception {
        ...
        if (autoShowInputMethod && getInputView() != null) {
            ...
            InputMethodUtils.showInputMethod(getInputView(), this.duration);
        }
    }
    ...
    public void setAutoShowInputMethod(boolean autoShow,boolean needAdjust,long duration) {
        this.autoShowInputMethod = autoShow;
        this.duration=duration;
        setAdjustInputMethod(needAdjust);
    }
