...
public class AlbumSystemActivity extends SkuaiDiBaseActivity {
	...
	private void initView() {
		...
		albumSystemAdapter = new AlbumSystemAdapter(AlbumSystemActivity.this, albumImageObjs);
	...
	private void setListener() {
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent intent = new Intent(AlbumSystemActivity.this,AlbumImageActivity.class);
