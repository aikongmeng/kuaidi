...
public class MediaFile {
    ...
    // 是否是WAV文件
    public static boolean isWavFile(int fileType){
        return fileType == FILE_TYPE_WAV;
    }
    ...
    public static boolean isWavFileType(String path){
        MediaFileType type = getFileType(path);
        if (null != type){
            return isWavFile(type.fileType);
        }
        return false;
    }
