...
public class WheelOptions<T> {
	...
	public void setPicker(ArrayList<T> options1Items,ArrayList<ArrayList<T>> options2Items,ArrayList<T> options3Items){
		this.linkage = true;
		this.mOptions1Items = options1Items;
		this.mOptions2Items = options2Items;
		this.mOptions5Items = options3Items;
...
//		wv_option2.setCurrentItem(0);// 初始化时显示的数据
		...
		wv_option3.setAdapter(new ArrayWheelAdapter(mOptions5Items,len));// 设置显示数据
